...
const READING_ANSWERS = {
  ...
  14: ['Б', 'выходить-выйти в свет 表示“出版、问世”；这里用过去时 вышел。', '该手册在教育出版社出版，印数 4 万册。'],
  15: ['Б', 'располагаться-расположиться 表示“位于”。', '脑部的活跃穴位位于耳廓上方两厘米的地方。'],
  16: ['В', 'считать кого-что каким，считают 要求第四格宾语 их 和第五格补语 ответственными。', '针灸师认为它们负责头部血液循环。'],
  17: ['В', 'массируя 是副动词。', '按摩这个穴位，可以使思维更清晰。'],
...
const DOCUMENT_EXERCISES = [
  ...
  [38, 'Заявление от: ...', ['Питер Адамс', 'г. Питера Адамса', 'Питера Адамса', 'Господина П. Адамса'], 'В', 'Питера Адамса 用第二格，即声明是由彼得·亚当斯写的。', '彼得·亚当斯。'],
  ...
  [41, 'Подпись: ...', ['Питер Адамс', 'С уважением П. П. Адамс', 'От Питера Адамса', 'Спасибо. Питер Адамс.'], 'А', '签名写姓名，使用第一格。', '彼得·亚当斯。'],
  [42, 'Дата заявления: ...', ['5 августа 2022 года', 'август, 5. 2022 – 08–15', 'август, 2022, 5', '5, август, 2022 год'], 'А', '日期写作：5 августа 2022 года。', '2022 年 8 月 5 日。'],
  [43, 'Адресат: ... медицинского факультета', ['Уважаемому господину декану', 'Господину декану', 'Уважаемому декану', 'Декану медицинского факультета'], 'Г', 'Декану 用第三格，表示写给系主任；这里不使用 Уважаемому。', '致医学系系主任。'],
  [44, 'Объяснительная записка: ... Анны Ивановой', ['госпожи студентки', 'от госпожи студентки', 'от госпожи', 'студентки Анны Ивановой'], 'Г', 'студентки 用第二格，即 Объяснительная записка студентки Анны Ивановой。', '学生安娜·伊万诺娃。'],
  [45, '… этого года я находилась в городской больнице №5', ['Май', 'В мае', 'На май', 'От мая'], 'Б', 'в мае 表示“在五月”。', '今年五月我在市立第五医院。'],
  [46, 'В больнице я находилась: ...', ['на неделю', 'в течение недели', 'за неделю', 'Г неделю'], 'Б', 'в течение недели 表示“一周的过程中”。', '住院一周。'],
  [47, 'Период пребывания: ...', ['от 15 до 22 мая', 'по 15 по 22 мая', 'с 15 по 22 мая', 'с 15 по 21 мая'], 'В', 'с 15 по 22 мая 包括 22 日，共 8 天。', '即 5 月 15 日至 22 日。'],
  [48, 'Цель лечения: ...', ['для лечения пневмонии', 'от лечения пневмонии', 'по лечению пневмонии', 'в лечении пневмонии'], 'А', 'для лечения пневмонии 表示“为了治疗肺炎”。', '为了治疗肺炎。'],
  [49, 'Дата объяснительной записки: ...', ['май, 25, 2022 г.', '25 мая 2022 г.', '2022, май, 25', '25, май, 2022 г.'], 'Б', '日期写作：25 мая 2022 г.。', '2022 年 5 月 25 日。'],
  [50, 'Подпись: ...', ['Анна', 'С приветом Анна Иванова', 'Анна Иванова', 'С дружеским приветом Анна Иванова'], 'В', 'Анна Иванова 是姓名，使用第一格。', '安娜·伊万诺娃。']
];
